...
@ExportedBean
  ...
  public StatisticsAction(AbstractProject project) { this.project = project; }
   ...
   */
  public String getUrlName() {    return this.hasPermission() ? ResourceBundle.EXT_URL_NAME : null;  }
  ...
  /**
   * use to get result in view26 Plugin page
   *
   * @param page
   * @return
   */
